...
/**
*
* File: _stats/_pages/stats/visits_per_day_last_2_months.php
* Version 1
...
for($x=0;$x<12;$x++){
	...
	$inp_data = $inp_data . "{
			  ...
			  text1: \"$get_this_stats_visit_per_month_month_short $get_this_stats_visit_per_month_year\",
			  text2: \"$get_last_stats_visit_per_month_month_short $get_last_stats_visit_per_month_year\",

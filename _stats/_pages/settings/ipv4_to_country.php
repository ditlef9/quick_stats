...
/**
*
* File: _stats/_pages/settings/ipv4_to_country.php
* Version 1
...
if($action == ""){
	...
	";
	$query = "SELECT ip_id, ip_start, ip_end, country FROM $t_stats_ip_to_country_lookup_ipv4";
...
elseif($action == "export_to_txt_files"){
	...
	<!-- Where am I? -->
		...
		<a href=\"index.php?open=$open&amp;page=$page&amp;editor_language=$editor_language\">IPv4 to Country</a>
		&gt;
	...
	if(!(is_dir("_cache/ipv4_to_country"))){
		mkdir("_cache/ipv4_to_country");
	}
...
?>";
			$fh = fopen("_cache/ipv4_to_country/$files_counter.php", "w+") or die("can not open file");
			fwrite($fh, $input);
			fclose($fh);

			// Echo file name
			echo"
				<li><a href=\"_cache/ipv6_to_country/$files_counter.php\">cache/ipv4_to_country/$files_counter.php</a></li>
			";
...
?>";
			...
			// Echo file name
			echo"
				<li><a href=\"_cache/ipv4_to_country/$files_counter.php\">cache/ipv4_to_country/$files_counter.php</a></li>
			";
	}

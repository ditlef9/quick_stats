...
if(isset($_SESSION['adm_user_id'])){
	...
	mysqli_query($link, "TRUNCATE TABLE $t_stats_countries_per_year") or die(mysqli_error($link));
	...
	if(isset($configGenerateTestDataSav) && $configGenerateTestDataSav == "1"){
		...
		while($row = mysqli_fetch_row($result)) {
			...
			(stats_country_id, stats_country_year, stats_country_name, stats_country_alpha_2, stats_country_unique, 
			stats_country_hits) 
			VALUES
			(NULL, $year, $inp_name_mysql, $inp_iso_mysql, $inp_unique, 

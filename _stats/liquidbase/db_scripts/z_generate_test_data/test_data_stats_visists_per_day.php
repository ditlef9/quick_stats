			...
			for($y=0;$y<12;$y++){
				...
				for($z=0;$z<31;$z++){
					...
					if(validateDate($date)){
						...
						`stats_visit_per_day_month`, `stats_visit_per_day_month_full`, `stats_visit_per_day_month_short`, `stats_visit_per_day_year`, stats_visit_per_day_date, 
						`stats_visit_per_day_human_unique`, 
						...
						$inp_month, '$inp_month_full', '$inp_month_short', $inp_year, '$date', 
						$inp_human_unique, 
